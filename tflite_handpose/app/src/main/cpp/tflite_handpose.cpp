 ...
 * -------------------------------------------------- */
int
init_tflite_hand_landmark(const char *detect_model_buf, size_t detect_model_size, 
                          const char *landmk_model_buf, size_t landmk_model_size)
{
    ...
    tflite_create_interpreter (&s_palm_interpreter, detect_model_buf, detect_model_size);
    ...
    /* Hand Landmark */
    tflite_create_interpreter (&s_hand_interpreter, landmk_model_buf, landmk_model_size);
