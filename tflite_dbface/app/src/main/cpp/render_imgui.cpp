...
render_gui (imgui_data_t *imgui_data)
{
    ...
    ImGui::Begin("Options");
    {
        ...
        ImGui::SliderFloat("Score thresh", &imgui_data->dbface_config.score_thresh, 0.0f, 1.0f);
        ImGui::SliderFloat("IOU   thresh", &imgui_data->dbface_config.iou_thresh,   0.0f, 1.0f);
